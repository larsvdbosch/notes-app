...
<template>
	...
	>
		<div class="flex flex-col gap-4 w-full">
			...
			>
				<NuxtLink to="/">
					<article class="flex flex-col gap-2 bg-primary hover:bg-[#121c2f] border border-primary-border transition-colors duration-[.25s] text-primary-dark p-4 rounded-lg w-full">
