...
<template>
  ...
  <aside
    class="fixed top-[var(--height-navbar)] block p-4 block-col gap-2 bg-[var(--color-background)] inset-0 z-50 border-t border-[var(--color-border)] transition-transform duration-[.25s] ease-out lg:hidden" :class="[
